...
notes_data_json = Path(__file__).with_name("notes_data.json")
...
def save_note():
    if list_notes.selectedItems():
        ...
        # if the terminal points directly to the folder where the script and text file are located, just use
        # notes_data_json = "notes_data.json"

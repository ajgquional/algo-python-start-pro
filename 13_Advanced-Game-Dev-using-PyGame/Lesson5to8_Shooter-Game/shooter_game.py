...
# background music
mixer.init()
mixer.music.load(script_dir / 'space.ogg')
mixer.music.play()
fire_sound = mixer.Sound(script_dir / 'fire.ogg')

# loading images
img_back = script_dir / "galaxy.jpg" # game background
img_bullet = script_dir / "bullet.png" # bullet
img_hero = script_dir / "rocket.png" # hero
img_enemy = script_dir / "ufo.png" # enemy
...
class GameSprite(sprite.Sprite):
    ...
    # method for drawing the character on the window
    def reset(self):
...
# main game loop:
run = True # flag is reset by the window close button
while run:
    ...
    if not finish:
        ...
        # possible defeat: missed too many monsters or the character collided with an enemy
    ...
    # the loop runs every 0.03 seconds
    time.delay(30)
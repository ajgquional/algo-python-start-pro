...
The sum of the three tries at pulse readings (before strain, right after strain,
and after a short break) ideally should be no more than 200 beats per minute.
We propose that children measure their pulse for 15 seconds and find the
result in beats per minute by multiplying by 4:
...
It is evaluated according to age using the table below:
...
“Weak” is separated from “satisfactory” by 5, and “good” from “satisfactory”
by 5.5.

So we will write a function ruffier_result(r_index, level) which will produce
the calculated Ruffier index and level “unsatisfactory” for the tested age,

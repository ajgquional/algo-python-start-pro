...
# file path fix (so that my_map.dat is created in the same folder as the script, not in the root of the project)
from pathlib import Path
my_map = Path(__file__).with_name('my_map.dat')
